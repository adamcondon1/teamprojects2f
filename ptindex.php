...
<html>
	...
	<body style='background-color:lightblue'>
	  <div class="wrapper">
		...
		<h2 align="center"></h2>
		<img src = "images/ben.png" alt = "ben"  height= "140px" width = "100px">
		<img src = "images/jordan.png" alt = "jordan"  height= "140px" width = "200px">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12" style="background-color:#14b5d0;">
					<h2 align="center""font-family: serif;"><b>Change Your Life Today.</b></h2>
				</div>
				<h1></h1>
				<h1></h1>
				<h1></h1>
